...
class OwnHomeDataMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeVInt(0)
        self.writeBoolean(False)
        self.writeVInt(0) # пред цена
        self.writeInt(0)
        self.writeString("Brawl Stars") # назва
        self.writeBoolean(False)
        self.writeString('offer_biodome') # фон
        self.writeVInt(-1)
        self.writeBoolean(False)
        self.writeVInt(0)
        self.writeVInt(0)
        ...
        if player.Trophies != 0:
            self.writeLong(3, 3500)  # TokensGained
        if player.Trophies == 0:
            self.writeLong(4, 0)  # TrophiesGained
        if player.Trophies != 0:
            self.writeLong(4, 1000)  # TrophiesGained
        ...
        if player.Trophies != 0:
            self.writeLong(14, 3500)  # CoinsGained
        ...
        self.writeString() #?
        self.writeVInt(0) #?
        self.writeVInt(2) #Defeates?
        self.writeVInt(15) # всего побед в чемпе
        self.writeVInt(1)  # Modifiers
        self.writeVInt(1)
        
        self.writeVInt(random.randint(1,14)) # победы которые ты сделал
        ...
        self.writeLong(65, 2)
        self.writeLong(1, 41000000)  # ThemeID
        ...
        random_popup = random.randint(0,3)
        if random_popup != 1:
